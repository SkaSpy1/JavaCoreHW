...
import lesson8.entity.WeatherFiveDays;
        ...
        switch (period) {
            ...
            case FIVE_DAYS: {
                ...
                for (int i = 0; i < numberOfElements; i++) {
                    ...
                    System.out.println("В городе " + selectedCity + " " + localDate.split("T")[0] + " " + weatherTextDay
                            + " днём" + " и дневная температура составляет " + maxTemperature + " C. Ночью " + weatherTextNight +
                            " и температура составляет " + minTemperature + " C.");
